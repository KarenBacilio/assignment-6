const battleship = () => {
  //object to store player 1 information
   ...
   for(let i = 0; i < 4; i++){
    ...
    //console log to see the 4 ships on the board
    ...
    console.log("below is player 2 board:", player2.gameBoard[0]);
    console.log(player2.gameBoard[1]);
    console.log(player2.gameBoard[2]);
    console.log(player2.gameBoard[3]);
  
  //made function so I can use the same game instructions for both players to alternate from
  /*for(let i=o;i<player1;i++){
    gameplay(i);
  }*/
    ...
    if(defendPlayer.gameBoard[attackY][attackX] === 1){
      ...
      console.log("This is the grid that we are attacking",defendPlayer.gameBoard[0]);
      ...
      if(defendPlayer.shipCount == 0){
        return `The winner is ${attackPlayer.name}`;
      }else{
    ...
    //return `The winner is...${player something}?`
    }gamePlay(player1, player2);
    }
  }
